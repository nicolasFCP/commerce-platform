...
CREATE FUNCTION public.save_store_payment_settings(
...
BEGIN
    ...
    VALUES (
        ...
        NULLIF(
            btrim(COALESCE(p_account_holder, '')),
            ''
        ),
        NULLIF(
            btrim(COALESCE(p_transfer_instructions, '')),
            ''
        )
    )
    ...
    DO UPDATE SET
        ...
        cash_on_delivery_enabled =
            EXCLUDED.cash_on_delivery_enabled,
